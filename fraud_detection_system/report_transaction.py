""" 
    ...
    4. If it does exceed suspect other transactions in cluster for fraud -> possibly call up or implement investigation process. 
    5. Re-cluster appropriately after fraudulent/legitimate labels are confirmed, to segregate confirmed legitimate cases and confirmed fraudulent cases, and sort unconfirmed legitimate cases. 
