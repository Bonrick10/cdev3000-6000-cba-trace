...
INSERT INTO transactions (sender_bsb, sender_account_number, receiver_bsb, receiver_account_number, amount, transaction_time, sender_latitude, sender_longitude, label, merchant_tags, session_id) VALUES (100000, 1, 100000, 2, 10.0, '2001-01-01 00:00:00', 0, 0, 'legitimate', 1, 1);
INSERT INTO transactions (sender_bsb, sender_account_number, receiver_bsb, receiver_account_number, amount, transaction_time, sender_latitude, sender_longitude, label, merchant_tags, session_id) VALUES (100000, 2, 100000, 1, 50.0, '2001-01-01 00:00:30', 0, 0, 'legitimate', 1, 2);